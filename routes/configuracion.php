...
Route::middleware(['auth', 'verified', EnsureSubscriptionAccess::class])->group(function () {
    ...
    Route::middleware(EnsureManagerAccess::class)->group(function () {
        ...
        Route::post('calendario/centro', [CalendarioController::class, 'storeCentro'])->name('calendario.storeCentro');
