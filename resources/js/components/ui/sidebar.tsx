  ...
  if (isMobile) {
    return (
        ...
        <SheetHeader className="sr-only">
          ...
          <SheetDescription>Muestra la navegacion lateral en movil.</SheetDescription>
        </SheetHeader>
        <SheetContent
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "text-sidebar-foreground ring-sidebar-ring hover:bg-sidebar-accent hover:text-sidebar-accent-foreground active:bg-sidebar-accent active:text-sidebar-accent-foreground [&>svg]:text-sidebar-accent-foreground flex min-w-0 -translate-x-px gap-2 overflow-hidden rounded-md outline-hidden focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>svg]:size-4 [&>svg]:shrink-0",
        "data-[active=true]:bg-sidebar-accent data-[active=true]:text-sidebar-accent-foreground",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        multiline
          ? "min-h-8 items-start px-1.5 py-1.5 [&>span:last-child]:break-words [&>span:last-child]:leading-tight [&>svg]:mt-0.5"
          : "h-7 items-center px-2 [&>span:last-child]:truncate",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
